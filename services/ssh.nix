{ config, lib, ... }: {
  ...
  config = {
    ...
    users.users."ruben".openssh.authorizedKeys.keys = config.ruben.ssh.authorizedKeys;
    users.users."root".openssh.authorizedKeys.keys = config.ruben.ssh.authorizedKeys;
